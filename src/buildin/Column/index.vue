<template>
  <div :style="styleStr">
    <ColumnGridLayout
      ref="ColumnGridLayoutRef"
      v-if="showFlag"
      :ref_string="ref_string"
      :column_edit_flag="column_edit_flag"
...
export default {
  ...
  methods: {
    ...
    updatePageColumnUser() {
      ...
      param.column_id = this.component.ref;
    ...
    findPageColumnUserCallBack(result) {
      ...
      if (result.objects.length > 0) {
        this.column_config = stringToObject(
          result.objects[0].column_config_str
        );
      }
      console.log("门户配置", this.column_config);
      this.updateColumnPage();
  ...
  created() {
    this.ref_string = this.component.ref;
    ...
    this.styleStr =
      this.styleStr + "overflow: " + this.devOption.option.overflow;
  },
  mounted() {
