<template>
  <div style="width: 100%;height: 350px;overflow: auto">
    ...
    <el-tree ref="componentChooseTreeRef" :data="componentChooseTreeData" node-key="id" :default-expand-all="true"
  ...
  methods: {
    ...
    findPageComponentByIDCallBack(result) {
      ...
      if (result.objects.length > 0) {
        let obj = {};
        obj.blue_script_in_out_config_str = result.objects[0].blue_script_in_out_config_str;
        obj.blue_script_logic_config_str = result.objects[0].blue_script_logic_config_str;
        obj.blue_script_node_config_str = result.objects[0].blue_script_node_config_str;
        obj.blue_script_visualize_config_str = result.objects[0].blue_script_visualize_config_str;
