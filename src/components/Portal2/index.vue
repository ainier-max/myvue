<template>
  <div style="width: 100%;height: 100%;background: #cbcbcb">
    ...
    <el-button type="info" v-if="showSave==true" @click="add()" style="position: fixed;left: 49%;top:90%;">新增栏目</el-button>
...
export default {
  ...
  methods:{
    ...
    updatePagePortalUser(){
      let param = {};
      param.sql = "page_portal2_user.update";
    ...
    findPagePortalUser(){
      let param = {};
      param.sql = "page_portal2_user.find";
      param.portal_id = this.$route.query.portal_id;
      param.userid = window.localStorage.getItem('loginUserid');
  ...
  created() {
    window.cbcPortal2Instance = getCurrentInstance();
  },
  mounted() {
